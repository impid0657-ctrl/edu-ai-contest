                    ...
                    <table class="table bordered-table sm-table mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img1.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img2.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <span class="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img3.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <span class="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img4.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <span class="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img6.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <span class="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $this->Url->build(['_name' => 'marketplaceDetails']) ?>" class="d-flex align-items-center">
                                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img5.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <span class="flex-grow-1 d-flex flex-column">
        ...
        <div class="modal-content radius-16 bg-base">
            ...
            <div class="modal-body p-24">
                <div class="d-flex flex-column gap-8">
                    <a href="#" class="d-flex align-items-center justify-content-between gap-8 p-16 border radius-8 bg-hover-neutral-50">
                        <span class="d-flex align-items-center gap-16">
                            <img src="<?= $this->Url->assetUrl('assets/images/crypto/wallet-icon1.png') ?>" alt="" class="flex-shrink-0 me-12 overflow-hidden">
                            <span class="text-md mb-0 fw-medium text-primary-light d-block">Bitcoin</span>
                        </span>
                    ...
                    <a href="#" class="d-flex align-items-center justify-content-between gap-8 p-16 border radius-8 bg-hover-neutral-50">
                        <span class="d-flex align-items-center gap-16">
                            <img src="<?= $this->Url->assetUrl('assets/images/crypto/wallet-icon2.png') ?>" alt="" class="flex-shrink-0 me-12 overflow-hidden">
                            <span class="text-md mb-0 fw-medium text-primary-light d-block">Coinbase Wallet</span>
                        </span>
                        <span class="text-secondary-light text-md"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
                    <a href="#" class="d-flex align-items-center justify-content-between gap-8 p-16 border radius-8 bg-hover-neutral-50">
                        <span class="d-flex align-items-center gap-16">
                            <img src="<?= $this->Url->assetUrl('assets/images/crypto/wallet-icon3.png') ?>" alt="" class="flex-shrink-0 me-12 overflow-hidden">
                            <span class="text-md mb-0 fw-medium text-primary-light d-block">Exodus Wallet</span>
                        </span>
                        <span class="text-secondary-light text-md"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
                    <a href="#" class="d-flex align-items-center justify-content-between gap-8 p-16 border radius-8 bg-hover-neutral-50">
                        <span class="d-flex align-items-center gap-16">
                            <img src="<?= $this->Url->assetUrl('assets/images/crypto/wallet-icon4.png') ?>" alt="" class="flex-shrink-0 me-12 overflow-hidden">
                            <span class="text-md mb-0 fw-medium text-primary-light d-block">Trust Wallet</span>
                        </span>
                        <span class="text-secondary-light text-md"><i class="ri-arrow-right-s-line"></i></span>
                    </a>
