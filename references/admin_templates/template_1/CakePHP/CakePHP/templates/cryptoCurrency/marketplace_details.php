            ...
            <div class="card-body px-24 py-32">
                ...
                <div class="d-flex align-items-center justify-content-between mb-24">
                    <div class="d-flex align-items-center">
                        <img src="<?= $this->Url->assetUrl('assets/images/crypto/bitcoin.png') ?>" alt="" class="w-72-px h-72-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                            ...
                            <div class="">
                                ...
                                <div class="mt-24 border radius-8 position-relative">
                                    ...
                                    <div class="p-16 d-flex align-items-center border-bottom">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                            <div class="d-flex align-items-center gap-8">
                                                <img src="<?= $this->Url->assetUrl('assets/images/crypto/crypto-img1.png') ?>" alt="" class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                <div class="flex-grow-1 d-flex flex-column">
                                    ...
                                    <div class="p-16 d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-grow-1 ps-16">
                                            <div class="d-flex align-items-center gap-8">
                                                <img src="<?= $this->Url->assetUrl('assets/images/crypto/paypal.png') ?>" alt="" class="w-24-px h-24-px rounded-circle flex-shrink-0 overflow-hidden">
                                                <div class="flex-grow-1 d-flex flex-column">
        ...
        <div class="modal-content radius-16 bg-base">
            <div class="modal-body px-32 py-56">
                <div class="text-center">
                    ...
                    <a href="<?= $this->Url->build(['_name' => 'index']) ?>" class="btn btn-primary-600 mt-32 px-24">Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
