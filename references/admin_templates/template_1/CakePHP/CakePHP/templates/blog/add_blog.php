                    ...
                    <div>
                        ...
                        <div class="upload-image-wrapper">
                            <div class="uploaded-img d-none position-relative h-160-px w-100 border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                                ...
                                <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover" src="<?= $this->Url->assetUrl('assets/images/user.png') ?>" alt="image">
                            </div>
...
<?php $this->start('script'); ?>
    <script src="<?= $this->Url->assetUrl('assets/js/editor.highlighted.min.js') ?>"></script>
    <script src="<?= $this->Url->assetUrl('assets/js/editor.quill.js') ?>"></script>
    <script src="<?= $this->Url->assetUrl('assets/js/editor.katex.min.js') ?>"></script>
        <script>
    // Editor Js Start
