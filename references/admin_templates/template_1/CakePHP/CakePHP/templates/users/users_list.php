<div class="card h-100 p-0 radius-12">
    <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
        ...
        <a href="<?= $this->Url->build(['_name' => 'addUser']) ?>" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
            ...
            <table class="table bordered-table sm-table mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list1.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list2.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list3.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list4.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list5.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list6.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list7.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list8.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list10.png') ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                <div class="flex-grow-1">
