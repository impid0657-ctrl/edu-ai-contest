                ...
                <div class="mt-16">
                    <ul>
                        <li class="item-active mb-4">
                            <a href="<?= $this->Url->build(['_name' => 'email']) ?>" class="bg-hover-primary-50 px-12 py-8 w-100 radius-8 text-secondary-light">
                        ...
                        <li class="mb-4">
                            <a href="<?= $this->Url->build(['_name' => 'stared']) ?>" class="bg-hover-primary-50 px-12 py-8 w-100 radius-8 text-secondary-light">
                                <span class="d-flex align-items-center gap-10 justify-content-between w-100">
                                    <span class="d-flex align-items-center gap-10">
                                        <span class="icon text-xxl line-height-1 d-flex">
            ...
            <div class="card-body p-0">
                <ul class="overflow-x-auto">
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Jerome Bell</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                    ...
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Kristin Watson</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Cody Fisher</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Dianne Russell</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Floyd Miles</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Devon Lane</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                    ...
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Annette Black</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Bessie Cooper</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Courtney Henry</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                    <li class="email-item px-24 py-16 d-flex gap-4 align-items-center border-bottom cursor-pointer bg-hover-neutral-200 min-w-max-content ">
                        ...
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium text-md text-line-1 w-190-px">Wade Warren</a>
                        <a href="<?= $this->Url->build(['_name' => 'viewDetails']) ?>" class="text-primary-light fw-medium mb-0 text-line-1 max-w-740-px">Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus. Aliquam pulvinar vestibulum blandit. Donec sed nisl libero. Fusce dignissim luctus sem eu dapibus</a>
                        <span class="text-primary-light fw-medium min-w-max-content ms-auto">6:07 AM</span>
                    </li>
                </ul>
