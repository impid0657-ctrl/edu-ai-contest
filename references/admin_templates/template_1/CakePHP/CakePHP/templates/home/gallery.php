            ...
            <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab" tabindex="0">
                <div class="row gy-4">
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img1.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img2.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img3.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img4.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img5.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img6.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img7.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img8.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img9.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img10.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img11.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
                    ...
                    <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="hover-scale-img border radius-16 overflow-hidden">
                            <div class="max-h-266-px overflow-hidden">
                                <img src="<?= $this->Url->assetUrl('assets/images/gallery/gallery-img12.png') ?>" alt="" class="hover-scale-img__img w-100 h-100 object-fit-cover">
                            </div>
                            <div class="py-16 px-24">
                                <h6 class="mb-4">This is Image title</h6>
                                <p class="mb-0 text-sm text-secondary-light">UI Design</p>
