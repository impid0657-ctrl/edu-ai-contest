...
<div class="chat-wrapper">
    <div class="chat-sidebar card">
        <div class="chat-sidebar-single active top-profile">
            <div class="img">
                <img src="<?= $this->Url->assetUrl('assets/images/chat/1.png') ?>" alt="image">
            </div>
            <div class="info">
            ...
            <div class="action">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg-end border">
                        <li>
                            <a href="<?= $this->Url->build(['_name' => 'chatProfile']) ?>" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2">
        ...
        <div class="chat-all-list">
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/2.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/3.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/4.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/5.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/6.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/7.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/8.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/9.png') ?>" alt="image">
                </div>
                <div class="info">
            ...
            <div class="chat-sidebar-single active">
                <div class="img">
                    <img src="<?= $this->Url->assetUrl('assets/images/chat/10.png') ?>" alt="image">
                </div>
                <div class="info">
    ...
    <div class="chat-main card">
        <div class="chat-sidebar-single active">
            <div class="img">
                <img src="<?= $this->Url->assetUrl('assets/images/chat/11.png') ?>" alt="image">
            </div>
            <div class="info">
                <h6 class="text-md mb-0">Kathryn Murphy</h6>
                <p class="mb-0">Available</p>
        ...
        <div class="chat-message-list">
            <div class="chat-single-message left">
                <img src="<?= $this->Url->assetUrl('assets/images/chat/11.png') ?>" alt="image" class="avatar-lg object-fit-cover rounded-circle">
