<div class="custom-bg">
    <div class="container container--xl">
        <div class="d-flex align-items-center justify-content-between py-24">
            <a href="<?= $this->Url->build(['_name' => 'index']) ?>" class="">
                <img src="<?= $this->Url->assetUrl('assets/images/logo.png') ?>" alt="">
            </a>
            <a href="<?= $this->Url->build(['_name' => 'index']) ?>" class="btn btn-outline-primary-600 text-sm"> Go To Home </a>
        </div>
        ...
        <div class="py-res-120">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-lg-block d-none">
                    <img src="<?= $this->Url->assetUrl('assets/images/coming-soon/coming-soon.png') ?>" alt="">
                </div>
            </div>
        </div>
    </div>
