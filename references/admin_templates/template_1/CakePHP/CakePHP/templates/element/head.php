<head>
    ...
    <title>Wowdash - Bootstrap 5 Admin Dashboard CakePHP Template</title>
    <link rel="icon" type="image/png" href="<?= $this->Url->assetUrl('assets/images/favicon.png') ?>" sizes="16x16">
    <!-- remix icon font css  -->
