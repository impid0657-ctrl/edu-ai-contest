                        ...
                        <div class="row justify-content-between g-3">
                            <div class="col-sm-4">
                                ...
                                <p class="mb-1 text-sm">
                                    Date Issued: <span class="editable text-decoration-underline">25/08/2020</span> <span class="text-success-main">
                                        <iconify-icon icon="mage:edit"></iconify-icon>
                                    </span>
                                </p>
                                <p class="mb-0 text-sm">
                                    Date Due: <span class="editable text-decoration-underline">29/08/2020</span> <span class="text-success-main">
                                        <iconify-icon icon="mage:edit"></iconify-icon>
                                    </span>
                                </p>
                            </div>
                            <div class="col-sm-4">
                                <img src="<?= $this->Url->assetUrl('assets/images/logo.png') ?>" alt="image" class="mb-8">
                                ...
                                <table class="text-sm text-secondary-light">
                                    <tbody>
                                        <tr>
                                            <td>Name</td>
                                            <td class="ps-8">
                                                : <span class="editable text-decoration-underline">Will Marthas</span> <span class="text-success-main">
                                                    <iconify-icon icon="mage:edit"></iconify-icon>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Address</td>
                                            <td class="ps-8">
                                                : <span class="editable text-decoration-underline">4517 Washington Ave.USA</span> <span class="text-success-main">
                                                    <iconify-icon icon="mage:edit"></iconify-icon>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Phone number</td>
                                            <td class="ps-8">
                                                : <span class="editable text-decoration-underline">+1 543 2198</span> <span class="text-success-main">
                                                    <iconify-icon icon="mage:edit"></iconify-icon>
                                                </span>
                                            </td>
                                        </tr>
...
<?php $this->start('script'); ?><script src = "<?= $this->Url->assetUrl('assets/js/invoice.js') ?>" ></script ><?php $this->end(); ?>