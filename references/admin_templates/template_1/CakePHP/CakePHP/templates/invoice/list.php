<div class="card">
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <a href="<?= $this->Url->build(['_name' => 'addNew']) ?>" class="btn btn-sm btn-primary-600"><i class="ri-add-line"></i> Create Invoice</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table bordered-table mb-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list1.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list2.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list3.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list4.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list5.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list6.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list7.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list8.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list9.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="<?= $this->Url->assetUrl('assets/images/user-list/user-list10.png') ?>" alt="" class="flex-shrink-0 me-12 radius-8">
