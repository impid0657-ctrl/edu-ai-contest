    ...
    <div class="col-xxl-3 col-lg-4">
        <div class="card h-100 p-0">
            <div class="card-body p-0">
                <div class="p-24">
                    <a href="<?= $this->Url->build(['_name' => 'textGeneratorNew']) ?>" class="btn btn-primary text-sm btn-sm px-12 py-12 w-100 radius-8 d-flex align-items-center justify-content-center gap-2">
                ...
                <ul class="ai-chat-list scroll-sm pe-24 ps-24 pb-24">
                    ...
                    <li class="mb-16">
                        <a href="<?= $this->Url->build(['_name' => 'textGenerator']) ?>" class="text-line-1 text-secondary-light text-hover-primary-600">UI/UX Design Roadmap write me the roadmap right now </a>
                    </li>
                    <li class="mb-16">
                        <a href="<?= $this->Url->build(['_name' => 'textGenerator']) ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                    </li>
                    <li class="mb-16">
                        <a href="<?= $this->Url->build(['_name' => 'textGenerator']) ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                    </li>
                    ...
                    <li class="mb-16">
                        <a href="<?= $this->Url->build(['_name' => 'textGenerator']) ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Online School Education Learning</a>
                    </li>
                    <li class="mb-16">
                        <a href="<?= $this->Url->build(['_name' => 'textGenerator']) ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Calorie-dense foods: Needs, healthy</a>
                    </li>
        ...
        <div class="chat-main card overflow-hidden">
            <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                <div class="d-flex align-items-center gap-16">
                    <a href="<?= $this->Url->build(['_name' => 'textGeneratorNew']) ?>" class="text-primary-light text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
            ...
            <div class="chat-message-list max-h-612-px min-h-612-px">
                ...
                <div class="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                    <div class="d-flex align-items-center gap-16">
                        <div class="img overflow-hidden flex-shrink-0">
                            <img src="<?= $this->Url->assetUrl('assets/images/chat/1.png') ?>" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                        </div>
                ...
                <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                    <div class="img overflow-hidden flex-shrink-0">
                        <img src="<?= $this->Url->assetUrl('assets/images/wow-dash-favicon.png') ?>" alt="image" class="w-44-px h-44-px rounded-circle object-fit-cover">
                    </div>
                    <div class="info flex-grow-1">
