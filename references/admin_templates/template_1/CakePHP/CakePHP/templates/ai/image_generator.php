                        ...
                        <div class="row g-3">
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="<?= $this->Url->assetUrl('assets/images/chatgpt/image-generator1.png') ?>" alt="" class="w-100 h-100 object-fit-cover">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="<?= $this->Url->assetUrl('assets/images/chatgpt/image-generator2.png') ?>" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="<?= $this->Url->assetUrl('assets/images/chatgpt/image-generator3.png') ?>" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="<?= $this->Url->assetUrl('assets/images/chatgpt/image-generator4.png') ?>" alt="" class="w-100 h-100 object-fit-cover">
                                    <div class="form-check style-check d-flex align-items-center position-absolute top-0 start-0 ms-8 mt-8">
                ...
                <div class="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                    ...
                    <div class="info flex-grow-1">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <div class="generated-image-item radius-8 overflow-hidden position-relative">
                                    <img src="<?= $this->Url->assetUrl('assets/images/chatgpt/image-generator5.png') ?>" alt="" class="w-100 h-100 object-fit-cover">
