                ...
                <div class="card">
                    ...
                    <div class="card-body p-24">
                        <div class="d-flex align-items-center flex-wrap gap-8">
                            ...
                            <a  href="<?= route_to('blog') ?>" class="btn btn-sm btn-primary-600 bg-primary-50 bg-hover-primary-600 text-primary-600 border-0 d-inline-flex align-items-center gap-1 text-sm px-16 py-6"> Codignator </a>
