                ...
                <div class="card-body p-24">
                    <form action="#" class="d-flex flex-column gap-20">
                        <div>
                            ...
                            <input type="text" class="form-control border border-neutral-200 radius-8"
                                ...
                                <div class="height-200">
                                    ...
                                    <div id="editor">
                                        <p class="">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                            Omnis dolores explicabo corrupti, fuga</p>
                                        <p><br></p>
                                    </div>
                                    <!-- Edit End -->
                                </div>
                            ...
                            <div class="upload-image-wrapper">
                                <div
                                    ...
                                    <button type="button"
                                        ...
                                        <iconify-icon icon="radix-icons:cross-2" class="text-2xl text-white">
                                        </iconify-icon>
                                    </button>
            ...
            <div class="d-flex flex-column gap-24">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column gap-24 p-24">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="blog-details.php" class="blog__thumb w-100 radius-12 overflow-hidden">
                                <img src="assets/images/blog/blog4.png" alt="Image"
                                    class="w-100 h-100 object-fit-cover">
                            </a>
                            <div class="blog__content">
                                <h6 class="mb-8">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="blog-details.php" class="blog__thumb w-100 radius-12 overflow-hidden">
                                <img src="assets/images/blog/blog7.png" alt="Image"
                                    class="w-100 h-100 object-fit-cover">
                            </a>
                            <div class="blog__content">
                                <h6 class="mb-8">
