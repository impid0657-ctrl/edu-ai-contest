    ...
    <div class="row row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4">
        ...
        <div class="col">
            <div class="card shadow-none border bg-gradient-end-3">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <img src="assets/images/currency/crypto-img1.png" alt="Image" class="w-40-px h-40-px rounded-circle flex-shrink-0">
        ...
        <div class="col">
            <div class="card shadow-none border bg-gradient-end-1">
                <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <img src="assets/images/currency/crypto-img2.png" alt="Image" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                        <div class="flex-grow-1">
        ...
        <div class="col">
            <div class="card shadow-none border bg-gradient-end-5">
                <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <img src="assets/images/currency/crypto-img3.png" alt="Image" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                        <div class="flex-grow-1">
        ...
        <div class="col">
            <div class="card shadow-none border bg-gradient-end-6">
                <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <img src="assets/images/currency/crypto-img4.png" alt="Image" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                        <div class="flex-grow-1">
        ...
        <div class="col">
            <div class="card shadow-none border bg-gradient-end-3">
                <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <img src="assets/images/currency/crypto-img5.png" alt="Image" class="w-40-px h-40-px rounded-circle flex-shrink-0">
                        <div class="flex-grow-1">
                        ...
                        <div class="card-body p-24">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="assets/images/currency/crypto-img1.png" alt="Image" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="assets/images/currency/crypto-img2.png" alt="Image" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="assets/images/currency/crypto-img3.png" alt="Image" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="assets/images/currency/crypto-img4.png" alt="Image" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="assets/images/currency/crypto-img5.png" alt="Image" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div>
                                <div class="card-slider">
                                    <div class="p-20 h-240-px radius-8 overflow-hidden position-relative z-1">
                                        <img src="assets/images/card/card-bg.png" alt="Image" class="position-absolute start-0 top-0 w-100 h-100 object-fit-cover z-n1">
        
                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <h6 class="text-white mb-0">Master Card</h6>
                                                <img src="assets/images/card/card-logo.png" alt="Image">
                                            </div>
