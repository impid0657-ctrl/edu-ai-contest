<?php
    ...
    $script='  <script src="assets/js/view-profile.js"></script>';
?>
            ...
            <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                ...
                <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                    <div class="text-center border border-top-0 border-start-0 border-end-0">
                        <img src="assets/images/user-grid/user-grid-img14.png" alt="Image" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover">
                        <h6 class="mb-0 mt-16">Robiul Hasan</h6>
                    ...
                    <div class="mt-24">
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-1 mb-12">
                                ...
                                <span class="w-70 text-secondary-light fw-medium">: Robiul Hasan</span>
                            </li>
                            <li class="d-flex align-items-center gap-1 mb-12">
                                <span class="w-30 text-md fw-semibold text-primary-light"> Email</span>
                                <span class="w-70 text-secondary-light fw-medium">: robiulhasan9559@gmail.com</span>
                            </li>
                            <li class="d-flex align-items-center gap-1 mb-12">
                            ...
                            <li class="d-flex align-items-center gap-1 mb-12">
                                ...
                                <span class="w-70 text-secondary-light fw-medium">: Development</span>
                            </li>
                            <li class="d-flex align-items-center gap-1 mb-12">
                                <span class="w-30 text-md fw-semibold text-primary-light"> Designation</span>
                                <span class="w-70 text-secondary-light fw-medium">: Front End Developer</span>
                            </li>
                            <li class="d-flex align-items-center gap-1 mb-12">
