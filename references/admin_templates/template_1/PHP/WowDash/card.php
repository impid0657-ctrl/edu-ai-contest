...
<?php include './layouts/layout-top.php' ?>
        ...
        <div class="row gy-4">
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="assets/images/card-component/card-img1.png" class="card-img-top" alt="Image">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="assets/images/card-component/card-img2.png" class="card-img-top" alt="Image">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="assets/images/card-component/card-img3.png" class="card-img-top" alt="Image">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <img src="assets/images/card-component/card-img4.png" class="card-img-top" alt="Image">
                    <div class="card-body p-16 text-center">
                        <h5 class="card-title text-lg text-primary-light
                    mb-6">This is Card title</h5>
                        <p class="card-text text-neutral-600">We quickly learn to fear and thus automatically
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card h-100 radius-12 p-0 overflow-hidden position-relative">
                    <div class="card-body p-0 gradient-overlay bottom-0 start-0">
                        <img src="assets/images/card-component/card-overlay-img1.png" alt="Image"
                            class="w-100 h-100">
    ...
    <div class="mb-40">
        ...
        <div class="row gy-4">
            <div class="col-xl-6">
                <div
                    class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="assets/images/card-component/horizontal-card-img1.png"
                            class="h-100 w-100 object-fit-cover" alt="Image">
                    </div>
