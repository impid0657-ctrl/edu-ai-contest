    ...
    <div class="row gy-4">
            ...
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="position-relative">
                        <img src="assets/images/videos/video-img1.png" class="w-100 h-100 object-fit-cover radius-8" alt="Image">
                ...
                <div class="card-body p-24">
                    <div class="row gy-4">
                        <div class="col-sm-6">
                            <div class="border bg-base radius-8 overflow-hidden ">
                                <div class="position-relative max-h-258-px overflow-hidden">
                                    <img src="assets/images/videos/video-img2.png" class="w-100 object-fit-cover" alt="Image">
                                    <a href="https://www.youtube.com/watch?v=Vr9WoWXkKeE" class="magnific-video bordered-shadow w-56-px h-56-px bg-white rounded-circle d-flex justify-content-center align-items-center position-absolute start-50 top-50 translate-middle z-1">
                                        <iconify-icon icon="ion:play" class="text-primary-600 text-xxl"></iconify-icon>
                                    </a>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="border bg-base radius-8 overflow-hidden ">
                                <div class="position-relative max-h-258-px overflow-hidden">
                                    <img src="assets/images/videos/video-img3.png" class="w-100 object-fit-cover" alt="Image">
                                    <a href="https://www.youtube.com/watch?v=Vr9WoWXkKeE" class="magnific-video bordered-shadow w-56-px h-56-px bg-white rounded-circle d-flex justify-content-center align-items-center position-absolute start-50 top-50 translate-middle z-1">
                                        <iconify-icon icon="ion:play" class="text-primary-600 text-xxl"></iconify-icon>
                                    </a>
                                </div>
        ...
        <div class="col-xxl-12">
            <div class="card h-100 p-0">
                ...
                <div class="card-body p-24">
                    <div class="position-relative">
                        <img src="assets/images/videos/video-img4.png" class="w-100 h-100 object-fit-cover radius-8" alt="Image">
                        <a href="https://www.youtube.com/watch?v=Vr9WoWXkKeE" class="magnific-video bordered-shadow w-56-px h-56-px bg-white rounded-circle d-flex justify-content-center align-items-center position-absolute start-50 top-50 translate-middle z-1">
                            <iconify-icon icon="ion:play" class="text-primary-600 text-xxl"></iconify-icon>
                        </a>
                    </div>
