                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div className="about-us-left-content mb-65">
                                <div className="title">
                                    ...
                                    <p className="pb-10">교육부와 한국교육학술정보원(KERIS)이 주최하는 제8회 교육 공공데이터 AI활용 경진대회는 교육 분야 최대 규모의 AI 공모전입니다.</p>
                                    <p>교육 현장의 실질적인 문제를 공공데이터와 AI 기술로 해결하는 혁신적인 솔루션을 발굴하고, 우수 작품을 시상하여 교육 혁신 생태계를 확대합니다.</p>
                                </div>
                        ...
                        <div className="row align-items-center justify-content-center flex-column-reverse flex-lg-row">
                            ...
                            <div className="col-xl-5 offset-xl-1 col-lg-5 col-md-12 col-sm-12 col-12">
                                <div className="title">
                                    ...
                                    <p className="pb-10">7회에 걸쳐 교육 현장의 혁신을 이끌어온 교육 공공데이터 AI활용 경진대회의 성과입니다.</p>
                                </div>
                            </div>{/* /col */}
                        </div>{/* /row */}
                    </div>{/* /container */}
                        ...
                        <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                            <div className="Speciality-left-content mb-20">
                                <div className="title">
                                    ...
                                    <p className="pb-10">교육 공공데이터를 활용한 실질적인 AI 솔루션 개발 경험과 전문가 피드백, 그리고 다양한 수상 혜택을 제공합니다.</p>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-6  col-lg-6  col-md-6  col-sm-6 col-12">
                                        <div className="single-service-content transition3 mb-55">
                                            ...
                                            <div className="service-text">
                                                <h6 className="f-700 mb-15">교육부 장관상</h6>
                                                <p>대상 수상팀에게는 교육부 장관상과 함께 최대 500만원의 상금이 수여됩니다</p>
                                            </div>
                                        </div>{/* /single-service-content */}
                                    </div>{/* /col */}
                                    <div className="col-xl-6  col-lg-6  col-md-6  col-sm-6 col-12">
