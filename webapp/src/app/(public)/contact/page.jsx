...
export default function ContactPage() {
  ...
  useEffect(() => {
    async function fetchPosts() {
      setLoading(true);
      try {
        const res = await fetch(`/api/board?type=qna&page=${page}&limit=20`);
        if (res.ok) {
                  ...
                  <div className="row">
                      <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex align-items-center justify-content-center">
                          <div className="page-title mt-110 text-center">
                              ...
                              <h1 className="text-capitalize f-700 mt-10 mb-20">문의하기</h1>
                              <nav aria-label="breadcrumb">
                                  <ol className="breadcrumb justify-content-center bg-transparent">
                                  <li className="breadcrumb-item"><a className="secondary-color3" href="/">홈</a></li>
                                  <li className="breadcrumb-item active text-capitalize secondary-color3" aria-current="page">문의하기</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
        ...
        <div className="container">
          ...
          {loading ? (
            ...
            <div className="text-center py-5">
              ...
              <p className="text-muted fs-5 mb-0">등록된 문의가 없습니다.</p>
            </div>
          ) : (
                    ...
                    <div className="secondary-border01 d-flex justify-content-between align-items-center py-3 px-4 transition3">
                      <div>
                        <h6 className="f-700 mb-1 black-color">
                          {post.title}
                          {post.is_secret && <span className="d-inline-block theme-bg text-white f-700 ms-2" style={{ borderRadius: "4px", fontSize: "11px", padding: "2px 8px" }}>비밀글</span>}
                        </h6>
          ...
          <div className="text-center mt-50">
            <div className="my-btn d-inline-block">
              <a href="/contact/write" className="btn theme-bg text-uppercase f-18 f-700">문의 작성하기</a>
            </div>
          </div>
        </div>
      </div>
