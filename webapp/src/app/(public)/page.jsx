                        ...
                        <div className="row align-items-center">
                            <div className="col-xl-6  col-lg-6  col-md-6  col-sm-12 col-12  d-flex align-items-center">
                                <div className="slider-content mt--30 position-relative">
                                    <span className="f-700 theme-color d-block pb-1" style={{ fontSize: "15px" }} data-aos="fade-right" data-aos-duration="2000" data-aos-delay="40">교육 분야의 공공데이터와 생성형 AI의 만남!</span>
